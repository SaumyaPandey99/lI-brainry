        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                ...
                <ul>
                    ...
                    <li>+91 5324851596</li>
                    <li>contact@Li-Brainry.com</li>
                    <li>Address: delhi 400065</li>
                </ul>

            </div>
        </div>
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Saumya pandey  | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;"> books </span>
                    <span class="me" style="font-size: 15px;">li-brainry</span></a>
            </div> 
        </div>
    </div>
</footer>