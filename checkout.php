    ...
    <div class="col-75">
      <div class="container">
        <form action="" method="POST">
          ...
          <a href="payscript.php" class="btn cart-btn1" style="display:<?php if($total>1){ echo 'inline-block'; }else{ echo 'none'; };?>" > &nbsp; Proceed to Checkout</a> <a class="cart-btn2" href="index.php">Continue Shoping</a>
